...
Router.route('/setup/brands', {name: 'brandsList'});
Router.route('/setup/gear_types', {name: 'gearTypesList'});

Router.route('/setup/manufacturers/:_id/edit', {
	name: 'brandEdit',
	data: function () { return Brands.findOne(this.params._id);}
});

Router.route('/setup/gear_types/:_id/edit', {
	name: 'gearTypeEdit',
	data: function () { return GearTypes.findOne(this.params._id);}
});

Router.route('/setup/brands/new', {name: 'brandNew'});
Router.route('/setup/gear_types/new', {name: 'gearTypeNew'});
